...
const slides: Slide[] = [
  ...
  },
  {
    ...
    subtitle: "Full Accounting Suite — Invoicing, Payables, Receivables, Expenses & Tax Compliance",
    icon: DollarSign,
    color: "from-green-600 to-green-400",
    department: "Finance & Accounts Team",
    content: {
      description:
        "A fully activated accounting suite enabling accountants to create, edit, renew, and manage all financial operations — invoicing, payables, receivables, credit control, bank reconciliation, expenses, tax filings, and compliance — with multi-currency support and cross-department data synchronization.",
      features: [
        "Invoicing Portal: Create, edit, and send customer invoices with auto-generated sequential references (INV-YYYY-NNNN)",
        "Payables Management: Track vendor bills, approve payments, and manage outgoing obligations with payable references (PAY-YYYY-NNNN)",
        "Receivables & Credit Control: Monitor outstanding balances, aging analysis, and credit exposure per client",
        "Expense Tracking: Submit, approve, and pay expenses with category classification and approval workflows",
        "Bank Reconciliation: Automated matching of bank transactions to invoices with weighted scoring algorithm",
        "Tax Filings & Compliance: Manage VAT, PAYE, Corporate Tax submissions with due date tracking and renewal reminders",
        "Job Costing: Track costs per consignment with approval and payment status — auto-created when a job is registered",
        "Multi-Currency Support: GHS, USD, EUR, GBP, CNY with exchange rate capture at transaction time",
        "Cross-Department Sync: Jobs registered in Operations auto-create finance skeletons; duty payments auto-generate GRA payables",
        "Payment Recording: Record partial or full payments against invoices with automatic status updates",
        "Professional PDF report generation and CSV/Excel export for all financial data",
        "Bank integration with automated alerts for low balances and large transactions",
      ],
      useCases: [
        "Accountant creates a new invoice → it auto-syncs to the client portal for customer visibility",
        "Operations registers a consignment → a job cost skeleton is auto-created in Finance",
        "Consignment reaches duty payment stage → a GRA payable is auto-generated",
        "Record a partial payment on an invoice → status auto-updates to 'Partially Paid'",
        "Submit a new expense for approval → management receives an instant notification",
        "Reconcile bank statements with system invoices using automated matching",
        "Track and renew tax filings before due dates with compliance reminders",
      ],
    },
  },
  {
    ...
    subtitle: "VIN-Verified Vehicle & General Goods Duty Calculator (GHS)",
    icon: Calculator,
    color: "from-orange-600 to-orange-400",
    department: "Customs & Finance",
    content: {
      description:
        "A dual-section AI-powered import duty calculator tailored for Ghana customs (ICUMS) logic. The Vehicles section supports VIN decoding, vehicle search by make/year/model, and manual entry. The General Goods section uses AI-assisted HS classification. Both sections support 195+ countries of origin, live or manual exchange rates, and generate branded A4 PDF reports.",
      features: [
        "Tabbed interface: Vehicles section and General Goods section",
        "Vehicle VIN Lookup: Decode vehicle details via NHTSA API (make, model, year, engine, body type)",
        "Vehicle Search: Find vehicles by selecting Make, Year, and Model from NHTSA database",
        "Vehicle Manual Entry: Enter vehicle details directly when VIN is unavailable",
        "General Goods: AI-driven HS code classification using Google Gemini with confidence scoring",
        "Global country of origin selection with 195+ countries for both sections",
        "Full Ghana levy breakdown: Import Duty (20%), VAT (15%), NHIL (2.5%), GETFund (2.5%), ECOWAS, AU, EXIM, Processing Fee",
        "Vehicle age penalty: Automatic surcharge for vehicles over 10 years old",
        "Estimated negotiable range (56.5% – 75.8%) for realistic duty planning",
        "CIF value calculation with Cost, Insurance, and Freight inputs",
        "Live exchange rate fetch or manual USD/GHS rate entry",
        "Professional branded A4 PDF report generation with dark blue/gold theme",
        "Verification links: ICUMS, GRA, AutoDutyChecker, Kitannex for cross-checking",
        "Disclaimer: Estimates are indicative — final duty per customs assessment",
      ],
      useCases: [
        "Enter a VIN → system auto-decodes vehicle → calculate duty instantly in GHS",
        "Search by Make + Year + Model when VIN is not available",
        "Client asks 'How much duty on electronics from China?' → use General Goods tab with AI HS classification",
        "Generate a branded PDF duty estimate to attach to a client quotation",
        "Compare duty across different HS codes to find the most accurate classification",
        "Verify estimates against ICUMS, AutoDutyChecker, or Kitannex using built-in links",
      ],
    },
  },
  {
  ...
  },
  {
    ...
    content: {
      description:
        "A hardened security framework protecting the platform from unauthorized access, data breaches, and cyber attacks — combined with full user management, role-based access control, and comprehensive audit trails.",
      features: [
        ...
        "Login history logging: IP address, user agent, and success/failure status",
        "Global session logout — sign out from all devices at once",
        "Inactivity timeout with 'Session expired' warning and auto-logout",
        "Security headers: X-Content-Type-Options, X-Frame-Options (DENY), strict Referrer-Policy",
        "Private file storage with authenticated-only access policies",
        "Role-based menu visibility and feature access",
        "Complete audit log of all system mutations with IP tracking",
      ...
      useCases: [
        ...
        "Use 'Log out all devices' after a security concern",
        "Monitor login history to detect suspicious access patterns",
      ],
    },
  },
  {

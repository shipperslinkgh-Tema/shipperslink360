...
const slides: Slide[] = [
  ...
  },
  {
    ...
    content: {
      description:
        "Manage your truck fleet, driver details, trip scheduling, and warehouse operations for efficient cargo movement. The New Trip form captures comprehensive details across six sections.",
      features: [
        "Vehicle & Driver section: Select truck type (40ft, 20ft, Towing, Cargo), enter truck number, driver name, driver's phone number, and license number",
        "Customer & Cargo section: Enter customer name, container number, and BL number",
        "Route & Schedule section: Specify origin, destination, pickup date, and expected delivery date",
        ...
        "Additional Notes section for extra trip details",
      ...
      useCases: [
        "Create a new trip by entering truck number, driver details, and route information",
        "Record driver's phone number and license number for each trip assignment",
